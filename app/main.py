...
from app.providers.iran.torob import TorobProvider
from app.providers.iran.digikala import DigikalaProvider

# Create DB tables
Base.metadata.create_all(bind=engine)

# Register providers
registry.register(TorobProvider())
registry.register(DigikalaProvider())
